...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[height=20em]{Rail.jpg}
\end{figure}
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[height=20em]{Electroaimant.jpg}
\end{figure}
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[height=20em]{Elastique.jpg}
\end{figure}
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[height=20em]{Inelastique.jpg}
\end{figure}
...
Pour calculer des valeurs théoriques, les formules~\eqref{ela} et~\eqref{inela} ont été utilisées donnant dans notre cas particulier où $v_2$ = 0
...
Les valeurs mesurées sont de $v_1' = 0 [m/s]$, $v_2' = 0.2238[m/s]$, l'erreur relative est donc:
